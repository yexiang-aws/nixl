...
def test_main(num_tokens: int, hidden: int, num_experts: int, num_topk: int,
              ...
              use_logfmt: bool = False, seed: int = 0, kineto: bool = False, fault_tolerance_test: bool = False):
    ...
    all_topk_idx = torch.full((max_num_ranks, num_tokens, num_topk), -1, dtype=topk_idx.dtype, device='cuda')
...
def main():
    ...
    parser.add_argument('--nvlink-backend', choices=['nixl', 'ipc', 'none'], default='ipc', help='NVLink backend to use')
